...
class PeriksaPasienController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Log::info('Periksa created', ['periksa_id' => $periksa->id, 'id_daftar_poli' => $request->id_daftar_poli]);
        ...
        // Redirect to the periksa detail (riwayat) so user can immediately see the saved record
        return redirect()->route('riwayat-pasien.show', $periksa->id)
