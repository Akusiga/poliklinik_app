                        ...
                        <form action="{{ route('periksa-pasien.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="input-stok" class="form-control" placeholder="Jumlah" min="1" value="1" style="max-width: 80px;">
...
<script>
    ...
    // Update stok input when selection changes and set allowed max
    ...
    btnTambahObat.addEventListener('click', () => {
        ...
        // Use the user-entered jumlah (inputStok) as kuantitas
        const kuantitas = parseInt(inputStok.value || 1);
        ...
        if (kuantitas > stok) {
            alert(`Jumlah yang diminta (${kuantitas}) melebihi stok tersedia (${stok}).`);
            return;
        }
        ...
        if (existingObat) {
            // Update kuantitas jika obat sudah ada (menambahkan jumlah yang sama)
    ...
    // Allow Enter key on select to add obat (optional)
    selectObat.addEventListener('keydown', (e) => {
        if (e.key === 'Enter') {
            btnTambahObat.click();
        }
    });
        ...
        daftarObat.forEach((obat, index) => {
            ...
            item.innerHTML = `
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <input type="number" class="form-control form-control-sm" style="width: 70px;" min="0" value="${obat.kuantitas}" readonly>
